...
console.log(chalk.yellow("                           ＴＥＮＥＯ－ＢＯＴ                         "));
console.log(chalk.yellow("╚══════════════════════════════════════════════════════════════════╝"));
...
console.log(chalk.magenta("   ╚══════╝ ╚═╝   ╚═╝  ╚═════╝     ╚═════╝ ╚═════╝  ╚═╝  ╚══════╝  ")); 
console.log(chalk.yellow("╔══════════════════════════════════════════════════════════════════╗")); 
console.log(chalk.yellow("                        ＤＥＰＩＮ-ＰＲＯＪＥＣＴ                     ")); 
console.log(chalk.yellow("╚══════════════════════════════════════════════════════════════════╝"));
 console.log("");
...
function displayAccountData(index) {
  ...
  console.log(chalk.cyan(`    ║                      𝔸 ℂ ℂ ℂ 𝕆 𝕌 ℕ 𝕋 ${index + 1}                  ║`));
  
  console.log(chalk.cyan(`    ╚══════════════════════════════════════════════════════════╝`));

  console.log(chalk.blue(`      ➤ EMAIL: ${accounts[index].email}`));

  console.log(chalk.green(`      ➤ UID: ${userIds[index]}`));

  console.log(chalk.green(`      ➤ BROWSER ID = ${browserIds[index]}`));

  console.log(chalk.green(`      ➤ POINTS TOTAL = ${pointsTotals[index]}`));

  console.log(chalk.green(`      ➤ POINTS TODAY = ${pointsToday[index]}`));

  console.log(chalk.yellowBright(`      ➤ CONNECT = ${messages[index]}`));

  const proxy = proxies[index % proxies.length];

  if (useProxy && proxy) {
    console.log(chalk.yellowBright(`      ➤ PROXY = ${proxy}`));
